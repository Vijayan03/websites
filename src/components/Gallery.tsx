...
import { galleryImages } from '../config/config';
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {galleryImages.map((src, i) => (
            <div
              key={i}
              className="reveal overflow-hidden rounded-2xl shadow-sm hover:shadow-xl cursor-pointer aspect-video bg-rose-200 transition-shadow duration-300"
